...
macro(enable_sanitizers sanitize_device)
    if(DNNL_USE_CLANG_SANITIZER MATCHES "Memory(WithOrigin)?")
        ...
        # TODO: add device sanitizer support?
    ...
    elseif(DNNL_USE_CLANG_SANITIZER STREQUAL "Address")
        ...
        set(DNNL_ENABLED_CLANG_SANITIZER "${DNNL_USE_CLANG_SANITIZER}")
        if(sanitize_device)
            append(CMAKE_CCXX_SANITIZER_FLAGS "-Xarch_device -fsanitize=address")
        endif()
...
elseif(UNIX OR MINGW)
    ...
    if(DNNL_WITH_SYCL OR CMAKE_BASE_NAME STREQUAL "icx" OR CMAKE_BASE_NAME STREQUAL "icpx")
        ...
        set(sanitize_device OFF)
        if(DNNL_WITH_SYCL OR NOT DNNL_GPU_RUNTIME STREQUAL "NONE")
            set(sanitize_device ON)
        endif()
        enable_sanitizers(sanitize_device)
    endif()
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
        ...
        enable_sanitizers(OFF)  # No device sanitizer support for Clang
