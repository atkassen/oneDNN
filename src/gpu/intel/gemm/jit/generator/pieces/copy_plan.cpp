...
enum class EarlyExit { False, True, None };

EarlyExit joinableCommon(const CopyOperand &o1, const CopyOperand &o2) {
    if (o1.kind != o2.kind) return EarlyExit::False;
    if (o1.kind == CopyOperand::Null) return EarlyExit::True;
    if (o1.type != o2.type || o1.stride != o2.stride) return EarlyExit::False;
    if (o1.kind == CopyOperand::Immediate)
        return (o1.value == o2.value) ? EarlyExit::True : EarlyExit::False;
    if (o1.temp != o2.temp) return EarlyExit::False;
    if (o1.temp && (o1.value != o2.value)) return EarlyExit::False;
    if (o1.neg != o2.neg) return EarlyExit::False;
    if (o1.abs != o2.abs) return EarlyExit::False;
    return EarlyExit::None;
}
    ...
    for (size_t n1 = 0; n1 < ninsn; n1++) {
        for (size_t n2 = n1 + 1; n2 < ninsn; n2++) {
            ...
            auto joinable = [&](const CopyOperand &o1, const CopyOperand &o2, bool *outTooFar = nullptr) {
                auto earlyExit = joinableCommon(o1, o2);
                if (earlyExit != EarlyExit::None)
                    return earlyExit == EarlyExit::True;
