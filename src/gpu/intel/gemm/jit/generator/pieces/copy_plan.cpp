...
void CopyPlan::optimizeSIMD()
{
    ...
    for (size_t n1 = 0; n1 < ninsns; n1++) {
        auto &i1 = insns[n1];
        if (i1.simd >= 32 || rounddown_pow2(i1.simd) == i1.simd) continue;
...
void CopyPlan::optimizeTranspose()
{
    ...
    auto ninsn = insns.size();
    size_t n2 = 0;
    for (size_t n1 = 0; n1 < ninsn; n1 = n2) {
        n2 = n1 + 1;
        auto &i1 = insns[n1];
