...
int grf_usage_bytes(fma_kind_t fma, dim_t b_iter, dim_t m_iter, dim_t n_iter,
    ...
    auto a_elems = static_cast<int>(b_iter * m_iter * k_iter);
    auto b_elems = static_cast<int>(b_iter * k_iter * n_iter);
    auto c_elems = static_cast<int>(m_iter * n_iter);
...
int slm_usage_bytes(const config_t &cfg, dim_t b_tg, dim_t m_tg, dim_t n_tg,
    ...
    auto a_slm_elems = static_cast<int>(n_tg * b_iter * m_iter * k_iter);
    auto b_slm_elems = static_cast<int>(m_tg * b_iter * n_iter * k_iter);
