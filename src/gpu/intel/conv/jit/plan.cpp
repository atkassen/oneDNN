...
int reorder_plan_t::estimate_regs() const {
    ...
    return static_cast<int>(utils::div_up(dst_size, grf_size()));
}
...
int reduce_plan_t::estimate_regs() const {
    ...
    return static_cast<int>(utils::div_up(ret, grf_size()));
}
...
grf_usage_t plan_t::grf_usage() const {
    ...
    auto nregs = [&](dim_t size) {
        return static_cast<int>(utils::div_up(size, grf_size()));
    };
